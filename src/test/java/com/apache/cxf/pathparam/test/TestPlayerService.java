...
public class TestPlayerService {
	...
	public static void main(String[] args) {
		...
		String returnValue1 = testPlayerService("http://localhost:8080/ApacheCXF-PathParam/services/player/welcome/Dravid");
		System.out.println("Response from first service : " + returnValue1);

		// invokes for first method with three argument
		String returnValue2 = testPlayerService("http://localhost:8080/ApacheCXF-PathParam/services/player/playerinfo/Sachin/41/200");
